...
namespace ERPManagementAPP.Modules
{
    public class Registrations
    {
        public static void Register(APIMethod apiMethod, Form1 form1)
        {
            ...
            #region 收付款管理(群組)
            PurchasePostingMaintainControl purchasePostingMaintainControl = new PurchasePostingMaintainControl(apiMethod, form1);//進貨/進貨退出
            ...
            MaintainModule.Add(purchasePostingMaintainControl); //8-收付款管理(群組)_進貨/進貨退出
